        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceCode = table.Column<string>(unicode: false, maxLength: 500, nullable: false),
                    CardCode = table.Column<string>(unicode: false, maxLength: 500, nullable: false),
                    Date = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PushLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedBy = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    IsDisabled = table.Column<bool>(nullable: true),
                    SchoolCode = table.Column<Guid>(nullable: false),
                    Name = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    LogoUrl = table.Column<string>(unicode: false, maxLength: 2000, nullable: true),
                    Phone = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCardHistoryItem", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDisabled = table.Column<bool>(nullable: true),
                    Name = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    DeviceCode = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    SchoolId = table.Column<int>(nullable: true),
                    Type = table.Column<int>(nullable: false),
                    RelatedDeviceId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Devices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Devices_Devices_RelatedDeviceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoUrl = table.Column<string>(unicode: false, maxLength: 2000, nullable: true),
                    SchoolId = table.Column<int>(nullable: true),
                    Grade = table.Column<int>(nullable: true),
                    StudentId = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    ...
                    UpdatedBy = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    IsDisabled = table.Column<bool>(nullable: true),
                    SchoolBusId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDisabled = table.Column<bool>(nullable: true),
                    Name = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    CardCode = table.Column<string>(unicode: false, maxLength: 500, nullable: true),
                    UserId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_RelatedDeviceId",
                table: "Devices",
